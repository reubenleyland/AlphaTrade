...
class MMMWAgent:
    ...
    def act(self, prices,quants, mid_price):
        ...
        return action_volumes
# Initialize the agent
mmmw_agent = MMMWAgent(num_actions=6, learning_rate=1, initial_volume=100)
...
def get_action(env_state):
    ...
    action_volumes = mmmw_agent.act(action_prices, action_quants, mid_prices)
